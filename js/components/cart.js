      ...
      <div class="modal-box">
        ...
        <div class="modal-body">
          ...
          <form id="checkoutForm" novalidate>
            ...
            <div id="checkoutError" style="display:none;color:var(--accent-pink);font-family:var(--font-mono-sub);font-size:0.85rem;margin-bottom:16px;padding:12px;background:rgba(255,0,140,0.1);border:1px solid var(--accent-pink);"></div>
